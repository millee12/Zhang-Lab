...
real :: t13,t14,t12,t23,t43,t32,t53,t73,t49,t83,t109
real :: F(2,2), RCG(2,2),pk2(3),rc1,rc2,kappa,CMR(3,3),ssuper(4,4)
real :: I1,I2,I3,dI1(3),dI2(3),dI3(3),ddI1(3,3),ddI2(3,3),ddI3(3,3)
real :: J1,J2,J3,dJ1(3),dJ2(3),dJ3(3),ddJ1(3,3),ddJ2(3,3),ddJ3(3,3)
...
!Invariants
I1=RCG(1,1)+RCG(2,2)+1.0
I2=0.5*(I1**2-(RCG(1,1)*RCG(1,1)+RCG(2,1)*RCG(2,1)+RCG(1,2)*RCG(1,2)+RCG(2,2)*RCG(2,2))-1.0)
...
dI2(3)=-1.0*(RCG(1,2)+RCG(2,1))
dI3(1)=2.0*RCG(2,2)
dI3(2)=2.0*RCG(1,1)
dI3(3)=-1.0*RCG(1,2)-RCG(2,1)
!(J)*
do i=1,3
	dJ1(i)=(I3**t13)*dI1(i)+t13*I1*(I3**t43)*dI3(i)
	dJ2(i)=(I3**t23)*dI2(i)+t23*I2*(I3**t53)*dI3(i)
	dJ3(i)=-1.0*t12*(I3**t12)*dI3(i)
enddo
...
pk2=rc1*dJ1+rc2*dJ2+kappa*(J3-1.0)*dJ3
...
do i=1,3
    do j=1,3
        CMR(i,j)=rc1*ddJ1(i,j)+rc2*ddJ2(i,j) &
            +kappa*(dJ3(i)*dJ3(j)+(J3-1.0)*ddJ3(i,j))
    enddo
enddo
